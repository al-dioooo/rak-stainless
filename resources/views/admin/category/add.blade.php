        ...
        <div class="container mx-auto">
            <form action="{{ route('admin.category.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="px-4 py-3 mb-8 space-y-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <div>
                        <label class="block mb-1 text-sm font-medium text-gray-700">Category
                            banner</label>
                        <div class="relative aspect-w-21 aspect-h-9">
                            ...
                            <input type="file" name="pict" class="hidden" id="pict" accept="image/*" x-on:change="view()">
                        </div>
                        @error('pict')
                ...
                <div>
                    ...
                    <div class="px-4 py-3 mb-8 space-y-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <div>
                            ...
                            <input type="text" name="slug" id="slug" :value="slugify(name)"
                            ...
                            @else
                                <p class="mt-2 text-sm text-gray-500">
                                    Slug automatically generated by category name.
                                </p>
                            @enderror
                        </div>
                    </div>
