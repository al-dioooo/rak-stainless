    ...
    <script>
        var sourceData = [
            @foreach ($order as $row)
                ...
                detail: '{{ route('admin.order.detail', ['id' => $row->id]) }}',
                },
            @endforeach
        ];
