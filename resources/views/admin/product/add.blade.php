...
@section('content')
    ...
    <div class="container grid px-6 mx-auto" x-data="formData()">
                    ...
                    <div class="flex flex-col space-y-4 md:space-y-0 md:space-x-4 md:flex-row">
                        <div class="md:w-2/5">
                            ...
                            <div class="relative aspect-w-1 aspect-h-1">
                                <img id="image"
                                    class="object-cover w-full h-full rounded-md @error('pict') border-red-500 border @enderror"
                                ...
                                <div class="flex items-end mt-1 space-x-4">
                                    <div class="w-5/6">
                                        <select id="category" name="category"
                                            class="block w-full px-3 py-2 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm @error('category') border-red-500 @enderror ">
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                <div>
                                    ...
                                    <div class="relative mt-1 rounded-md shadow-sm">
                                        ...
                                        <input type="text" name="price" id="price" autocomplete="none"
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-1 rounded-md shadow-sm">
                                        ...
                                        <input type="text" name="discount" id="discount" autocomplete="none"
                                            class="block w-full pr-2 border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500 pl-9 sm:text-sm">
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-1 rounded-md shadow-sm">
                                        ...
                                        <input type="text" name="weight" id="weight" autocomplete="none"
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-1 rounded-md shadow-sm">
                                        <input type="number" name="stock" id="stock" autocomplete="none"
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea id="description" name="description" rows="8" autocomplete="none"
                                class="block w-full mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm @error('description') border-red-500 @enderror "></textarea>
                        </div>
                        @error('description')
                            <p class="mt-2 text-sm text-red-500">
                                {{ $message }}
                ...
                <div>
                    ...
                    <div class="px-4 py-3 mb-8 space-y-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        <div>
                            ...
                            <input type="text" name="key" id="key" :value="name" autocomplete="none"
                            ...
                            @else
                                <p class="mt-2 text-sm text-gray-500">
                                    Keyphrase automatically generated by product name.
                                </p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="slug" id="slug" :value="slugify(name)" autocomplete="none"
                            ...
                            @else
                                <p class="mt-2 text-sm text-gray-500">
                                    Slug automatically generated by product name.
                                </p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea id="meta_description" name="meta_description" rows="3" autocomplete="none"
                                    class="block w-full mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm @error('meta_description') border-red-500 @enderror "></textarea>
                            </div>
