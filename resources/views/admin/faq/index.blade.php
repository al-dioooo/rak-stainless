                ...
                <div class="flex">
                    <div class="relative w-full max-w-sm focus-within:text-primary-500">
                        ...
                        <input x-ref="searchField" x-model="search" x-on:click="viewPage(0)"
                            ...
                            type="text" placeholder="Search faqs" aria-label="Search">
                    </div>
                </div>
                <div class="flex">
                                ...
                                <template x-for="item in filteredItems" :key="item">
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900" x-text="item.question"></div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex space-x-4">
                                                <form action="{{ route('admin.faq.edit') }}">
