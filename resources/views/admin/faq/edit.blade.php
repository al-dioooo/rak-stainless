            ...
            <form action="{{ route('admin.faq.update') }}" method="POST">
                ...
                <div class="px-4 py-3 mb-8 space-y-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <div>
                        ...
                        <input type="text" name="question" id="question" autocomplete="none"
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea id="answer" name="answer" rows="3" autocomplete="none"
                                class="block w-full mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 sm:text-sm @error('answer') border-red-500 @enderror ">{{ old('answer') ?: $faq->answer }}</textarea>
                            @error('answer')
                                <p class="mt-2 text-sm text-red-500">
                                    {{ $message }}
                                </p>
